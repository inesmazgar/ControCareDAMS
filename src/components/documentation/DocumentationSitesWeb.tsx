        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto">
          {sites.map((site, index) => (
            <motion.div
              ...
              className={`p-4 bg-white border-2 rounded-2xl transition-all ${highlightedSourceId && (site.titre.includes(highlightedSourceId) || site.description.includes(highlightedSourceId)) ? 'shadow-2xl ring-4 ring-red-100 z-10' : 'hover:border-red-400 hover:shadow-xl'}`}
            >
