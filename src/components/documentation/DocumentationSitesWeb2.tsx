...
export function DocumentationSitesWeb2() {
  const sites = [
    {
      titre: "Agence du Numérique en Santé",
      url: "https://esante.gouv.fr",
      description: "Stratégie nationale de santé numérique."
    },
    {
      titre: "Ordre National des Médecins",
      url: "https://www.conseil-national.medecin.fr",
      description: "Déontologie et bonnes pratiques en télémédecine."
    },
    {
      titre: "Ministère de la Santé - Numérique",
      url: "https://sante.gouv.fr",
      description: "Politiques publiques et réglementation en e-santé."
    },
    {
      titre: "European Health Data Space",
      url: "https://health.ec.europa.eu",
      description: "Cadre européen pour les données de santé."
    }
  ];
    ...
    <div className="h-full w-full bg-gradient-to-br from-red-50 via-white to-red-50 overflow-y-auto flex items-center justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
        <div className="flex items-center justify-center mb-4">
          <Globe className="text-red-600 mr-4" size={40} />
          <h1 className="text-gray-900 text-3xl font-bold">Sites Web et Ressources en ligne</h1>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-red-600 mb-2 font-mono">
                    <a href={site.url} target="_blank" rel="noopener noreferrer" className="flex items-center">
                      {site.url}
