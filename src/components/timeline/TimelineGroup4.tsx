...
export function TimelineGroup4() {
  const events = [
    {
      year: '2022',
      title: 'Nouveau cadre réglementaire',
      description: 'Ajustements des conditions de remboursement et renforcement des exigences de sécurité.',
      category: 'legislation',
      color: 'emerald',
    },
    {
      year: '2023',
      title: 'Essor de l\'IA en santé',
      description: 'Intégration croissante de l\'intelligence artificielle dans les outils de télémédecine.',
      category: 'innovation',
      color: 'blue',
    },
    {
      year: '2024',
      title: 'Débats actuels',
      description: 'Questions sur l\'équité d\'accès, la protection des données et l\'avenir de la relation médecin-patient.',
    ...
    <div className="h-full w-full bg-gradient-to-br from-gray-50 via-white to-gray-50 overflow-y-auto flex items-center justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-center mb-8">
          ...
          <h1 className="text-gray-900 text-4xl font-bold">Chronologie 2022-2024</h1>
        </div>
        
        <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
          Les évolutions récentes et les défis actuels de la télémédecine.
        </p>
